...
from teste.Const import C_WHITE, WIN_HEIGHT, MENU_OPTION, EVENT_ENEMY, SPAWN_TIME, C_GREEN, C_CYAN, EVENT_TIMEOUT, \
    TIMEOUT_STEP, TIMEOUT_LEVEL, TIMEOUT_LEVEL3
from teste.Enemy import Enemy
from teste.Entity import Entity
from teste.EntityFactory import EntityFactory
from teste.EntityMediator import EntityMediator
...
class Level:
    ...
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int]):
        ### Adição de tempo da fase do nivel 3.
        if name != 'Level3':
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == EVENT_ENEMY:
                    ### Adcionando o inimigo na fase 3 e adicionando a direção do inimigo na fase 3.
                    if self.name != "Level3" :
